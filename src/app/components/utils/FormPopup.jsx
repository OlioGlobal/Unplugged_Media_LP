      ...
      <div className="bg-[#EAE6E3] mx-[4%] p-5 md:p-8 max-w-md w-full shadow-xl">
        ...
        <form onSubmit={handleSubmit} id="leadForm">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="bg-[#DD3333] hover:bg-[#be1c1c] text-[18px] py-[9px] px-[20px] cursor-pointer rounded-[5px] text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
